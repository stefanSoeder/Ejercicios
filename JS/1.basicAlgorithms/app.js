...
let j = 5;
let o = p + j;
console.log("operador correcto", o);
...
// const avengers = ["HULK", "SPIDERMAN", "BLACK PANTHER"];
console.log("núumero de heroes", avengers.length);
...
console.log("Spliced R&M", rickAndMortyCharacters);
...
if (number3 * 5 == 1 && number1 * 2 == number2) {
  console.log(
